    ...
    return (
        ...
        style={{
          ...
          //filter: 'brightness(80%)',
            ...
            <h1 className="text-3xl font-bold mb-6 pt-8 font-mina">Søknadsskjema</h1>
            ...
            {/* Motivajonstekst */}
            <div>
                <label htmlFor="priority" className="block text-sm md:text-lg font-semibold">Prioritering</label>
                <select
                id="prority"
                name="prority"
                ...
                {errors.priority && <p className="text-red-500 text-sm md:text-lg">{errors.priority}</p>}
            </div>
    
            {/* CV opplasting */}
            <div>
                <label htmlFor="resume" className="block text-sm md:text-lg font-semibold">Last opp karakterutskrift:</label>
                <input
                type="file"
                id="resume"
                name="resume"
