...
export default function TeacherNotes() {
    ...
    const notesOpen = useTeacherStore((s) => s.panelsOpen.notes);
        ...
        {left}
            ...
            <div className="overflow-hidden mt-3">
                ...
                <div className="py-2 flex items-center gap-3 w-full border-b border-redish">
                    ...
                    <div className="w-full font-semibold font-mina text-sm uppercase">Rediger &quot;{active?.title ?? "notat"}&quot;:</div>
