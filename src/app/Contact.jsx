            ...
            <div className="flex flex-col justify-between items-center md:items-center w-full max-w-screen-lg h-full gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full w-full px-4 items-start">
                    <div className="bg-black/40 mx-4 md:mx-0 flex flex-col rounded-xl p-2 font-mina gap-4 md:h-72">
                        <h1 className="text-moreredish text-center">
                            Kontakt oss:
                        </h1>
                        <div className="font-mina text-xl p-2 hover:bg-moreredish rounded-xl">
                    ...
                    <div className="bg-black/40 mx-4 md:mx-0 rounded-xl flex flex-col p-2 font-mina gap-4 md:h-72">
                        ...
                        <div className="font-mina text-xl p-2 hover:bg-moreredish rounded-xl flex flex-row">
                    ...
                    <div>
                        <div className="bg-black/40 mx-4 md:mx-0 rounded-xl p-2 pb-4 gap-4 font-mina md:h-72 flex flex-col justify-start items-start">
                            <h1 className="text-moreredish pb-2 text-center w-full">
                                Besøk oss:
                            </h1>
                    ...
                    <div className="bg-black/40 mx-4 md:mx-0 rounded-xl p-2 font-mina mb-8 flex flex-col gap-4 h-auto">
                        ...
                        <a className="hover:bg-moreredish p-2 rounded-xl" target="_blank" href="/publicfiles/ordensreglement.pdf">
                            <p className="font-mina text-lg">Ordensreglement</p>
                        </a>
                        <a className="hover:bg-moreredish p-2 rounded-xl" target="_blank" href="/publicfiles/inntaksreglement.pdf">
                            <p className="font-mina text-lg">Inntaksreglement</p>
                        </a>
                        <a className="hover:bg-moreredish p-2 rounded-xl" target="_blank" href="/publicfiles/FagOgTimerCreate.pdf">
